...
class GetPlanProductsUseCase(
    ...
    suspend operator fun invoke(planId: String, page: Int = 1, items: Int = 20): ApiResult<PlanProductsResponse> {
        return plansRepository.getPlanProducts(planId, page, items)
    }
}