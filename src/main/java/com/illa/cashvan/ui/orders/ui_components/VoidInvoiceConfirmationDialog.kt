...
@Composable
fun VoidInvoiceConfirmationDialog(
    onDismiss: () -> Unit,
    onConfirm: () -> Unit
) {
        ...
        Card(
            ...
            Column(
                ...
                Column(
                    ...
                    Text(
                        text = "هل أنت متأكد إنك عايز تلغي الفاتورة؟",
                        fontSize = 20.sp,
                    ...
                    Text(
                        text = "بعد التأكيد، الفاتورة هتتلغى وهيرجع الأوردر لحالة جارية.",
                        fontSize = 16.sp,
...
@Composable
fun VoidInvoiceConfirmationDialogPreview() {
